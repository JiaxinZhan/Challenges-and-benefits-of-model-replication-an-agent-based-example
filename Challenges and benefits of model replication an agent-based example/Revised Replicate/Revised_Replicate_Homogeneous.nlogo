...
to store-raster
  ...
  gis:store-dataset patches_out (word "C:/Users/DELL/Desktop/Thesis_backup/NetLogo_Noscaled_Results/TestPatches/" "Homogeneous_Fragstat_PatchFile_" iterate_counter ".txt")
...
to setup-output-file
  if (file-exists? "Homogeneous_Test.csv")
  [
    carefully
      [ file-delete "Homogeneous_Test.csv" ]
      [ print error-message ]
  ]

  file-open "Homogeneous_Test.csv"
  file-type "mru,"
  file-type "vru,"
  file-type "dor,"
  file-print "cgini,"
...
1395
43
Homogeneous Case (Revised Replicate)
24
0.0
1
