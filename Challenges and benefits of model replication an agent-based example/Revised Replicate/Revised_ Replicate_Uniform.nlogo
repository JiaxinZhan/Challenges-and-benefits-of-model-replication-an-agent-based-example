...
to store-raster
  ...
  gis:store-dataset patches_out (word "C:/Users/DELL/Desktop/Thesis_backup/NetLogo_Noscaled_Results/TestPatches/" "Uniform_Fragstat_PatchFile_" iterate_counter ".txt")
...
to setup-output-file
  if (file-exists? "Uniform_Test.csv")
  [
    carefully
      [ file-delete "Uniform_Test.csv" ]
      [ print error-message ]
  ]

  file-open "Uniform_Test.csv"
  file-type "mru,"
  file-type "vru,"
  file-type "dor,"
  file-print "cgini,"
...
to set-alphas
  set alphac random-float 1
  set alphaq random-float 1
  set alphas random-float 1
end
...
1395
43
Uniform Case (Revised Replicate)
24
0.0
1
