...
to store-raster
  ...
  gis:store-dataset patches_out (word "C:/Users/DELL/Desktop/NetLogo_Scaled_25June2018/Results/Normal/" "Rescaled_Normal_Fragstat_PatchFile_" iterate_counter ".txt")
...
to setup-output-file
  if (file-exists? "Rescaled_Normal_Test.csv")
  [
    carefully
      [ file-delete "Rescaled_Normal_Test.csv" ]
      [ print error-message ]
  ]

  file-open "Rescaled_Normal_Test.csv"
  file-type "mru,"
  file-type "vru,"
  file-type "dor,"
  file-print "cgini,"
