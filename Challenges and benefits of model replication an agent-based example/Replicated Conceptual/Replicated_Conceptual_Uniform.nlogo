...
to store-raster
  ...
  gis:store-dataset patches_out (word "C:/Users/DELL/Desktop/NetLogo_Scaled_25June2018/Results/Uniform/" "Rescaled_Uniform_Fragstat_PatchFile_" iterate_counter ".txt")
...
to setup-output-file
  if (file-exists? "Rescaled_Uniform_Test.csv")
  [
    carefully
      [ file-delete "Rescaled_Uniform_Test.csv" ]
      [ print error-message ]
  ]

  file-open "Rescaled_Uniform_Test.csv"
  file-type "mru,"
  file-type "vru,"
  file-type "dor,"
  file-print "cgini,"
...
1221
45
Uniform Case (Replicated Conceptual)
24
0.0
1
