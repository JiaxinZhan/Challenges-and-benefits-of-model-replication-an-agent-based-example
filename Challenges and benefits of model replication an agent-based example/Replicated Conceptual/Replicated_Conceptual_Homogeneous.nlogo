...
to go
  locate-resident   ;; locate resident
...
to store-raster
  ...
  gis:store-dataset patches_out (word "C:/Users/DELL/Desktop/NetLogo_Scaled_25June2018/Results/Homogeneous/" "Rescaled_Homogeneous_Fragstat_PatchFile_" iterate_counter ".txt")
...
to setup-output-file
  if (file-exists? "Rescaled_Homogeneous_Test.csv")
  [
    carefully
      [ file-delete "Rescaled_Homogeneous_Test.csv" ]
      [ print error-message ]
  ]

  file-open "Rescaled_Homogeneous_Test.csv"
  file-type "mru,"
  file-type "vru,"
  file-type "dor,"
  file-print "cgini,"
...
1274
51
Homogeneous Case (Replicated Conceptual)
24
0.0
1
